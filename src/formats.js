...
(function (global) {
  ...
  var FORMATS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "crop-1-33", name: "1.33× 크롭 (Leica M8 등)", w: 27, h: 18 },
        { id: "four-thirds", name: "포서드 / 마이크로 포서드 (4/3)", w: 17.3, h: 13.0 },
    ...
    },
    {
      group: "파노라마 (스윙렌즈 · 와이드)",
      items: [
        { id: "xpan", name: "Hasselblad XPan / Fuji TX (24×65)", w: 65, h: 24, note: "35mm 듀얼포맷의 파노라마 모드 노광" },
        { id: "widelux-35", name: "Widelux (35mm · 24×59)", w: 59, h: 24, note: "스윙렌즈, 실제 수평 화각 126°" },
        { id: "horizon-35", name: "Horizon 202/Perfekt (35mm · 24×58)", w: 58, h: 24, note: "스윙렌즈" },
        { id: "widelux-1500", name: "Widelux 1500 (중형 120 · 50×122)", w: 122, h: 50, note: "120 필름 스윙렌즈, 실제 수평 화각 150°" },
        { id: "horizon-205pc", name: "Horizon-205PC / PAN-120 (중형 · 추정)", w: 120, h: 58, est: true, note: "120 중형 스윙렌즈 프로토타입(소량 생산·단종), 노광 치수 추정" }
      ]
    },
    {
  ...
  var FORMAT_NOTES = [
    ...
    "스윙렌즈 파노라마(Widelux·Horizon)는 렌즈가 회전하며 노광해 실제 수평 화각이 렌즈 회전각으로 결정됩니다(Widelux 35mm ≈126°, Widelux 1500 ≈150°). 여기 표시되는 화각은 프레임폭·초점거리 기반 계산값이라 실제 스윙 화각과는 다릅니다. XPan은 스윙렌즈가 아니어서 해당하지 않습니다.",
    "실제 심도의 착란원(CoC)은 포맷 대각 ÷ 1500을 사용합니다. (관행에 따라 0.029~0.030mm 등으로 잡으면 값이 달라집니다.)",
